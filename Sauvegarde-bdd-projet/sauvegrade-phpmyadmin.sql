...
--
-- Hôte : localhost:3306
-- Généré le : ven. 07 avr. 2023 à 10:43
...
INSERT INTO `utilisateur` (`id`, `role`, `nom`, `prenom`, `email`, `mdp`) VALUES
(3, 1, 'VIVIAN', 'Bastien', 'bastienvivian29@gmail.com', '*CC67043C7BCFF5EEA5566BD9B1F3C74FD9A5CF5D');
...
('maintenance', '{\"0\":{\"db\":\"pppe\",\"table\":\"utilisateur\"},\"1\":{\"db\":\"pppe\",\"table\":\"role\"},\"3\":{\"db\":\"pppe\",\"table\":\"admin\"}}');
...
('maintenance', '[{\"db\":\"pppe\",\"table\":\"utilisateur\"},{\"db\":\"pppe\",\"table\":\"role\"},{\"db\":\"pppe\",\"table\":\"user\"},{\"db\":\"pppe\",\"table\":\"admin\"},{\"db\":\"projet-pppe\",\"table\":\"pma__users\"},{\"db\":\"projet-pppe\",\"table\":\"pma__bookmark\"}]'),
('root', '[{\"db\":\"pppe\",\"table\":\"admin\"}]');
...
('maintenance', '2023-04-07 08:42:48', '{\"lang\":\"fr\",\"Console\\/Mode\":\"show\",\"Console\\/Height\":60.994}');
